import { BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from '@miljan9602/sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from '@miljan9602/v2-sdk'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  nearestUsableTick,
